#Written by Wesley Reid (https://lostsouls.org)
...
if __name__ == "__main__": 
    ...
    plus = Button(gui, text=' ADD ', fg='black', bg='light gray', 
                  command=lambda: press("+"), height=3, width=7) 
    plus.grid(row=2, column=3) 
  
    minus = Button(gui, text=' SUB ', fg='black', bg='light gray', 
                   command=lambda: press("-"), height=3, width=7) 
    minus.grid(row=3, column=3) 
  
    multiply = Button(gui, text=' MULT ', fg='black', bg='light gray', 
                      command=lambda: press("*"), height=3, width=7) 
    multiply.grid(row=4, column=3) 
  
    divide = Button(gui, text=' DIV ', fg='black', bg='light gray', 
                    command=lambda: press("/"), height=3, width=7) 
    divide.grid(row=5, column=3) 
  
    equal = Button(gui, text=' E ', fg='black', bg='light gray', 
                   command=equalpress, height=3, width=7) 
    equal.grid(row=5, column=2) 
  
    clear = Button(gui, text=' C ', fg='black', bg='light gray', 
